...
var mapStateToProps = function mapStateToProps(state, ownProps) {
    ...
    var bgColor = state.outerColor || ownProps.bgColor;
...
var header__ref2 = Object(preact_min["h"])('nav', null);
...
var header_BaseHeader = function (_Component) {
    ...
    BaseHeader.prototype.render = function render() {
        var headerStyle = 'background-color: ' + this.props.bgColor;
...
var colorpicker_style = __webpack_require__("wekc");
 ...
 * @returns {Number}
 */
var calculateTouchAngle = function calculateTouchAngle(_ref3) {
    var left = _ref3.left,
        top = _ref3.top,
        width = _ref3.width,
        height = _ref3.height,
...
var home_Home = (_dec = connect(reducers_0, actions_namespaceObject), _dec(_class = function (_Component) {
    ...
    function Home() {
        ...
        return _ret = (_temp = (_this = home__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.setOuterColor = function (data) {
            _this.props.setOuterColor(data);
        }, _this.setInnerColor = function (data) {
            _this.props.setInnerColor(data);
    ...
    Home.prototype.render = function render() {
        return Object(preact_min["h"])(
            ...
            Object(preact_min["h"])(colorpicker_ColorPicker, { text: 'Outer color', onChange: this.setOuterColor })
        );
    };
...
var app__ref = Object(preact_min["h"])(header, { bgColor: '#673AB7' });
...
// removed by extract-text-webpack-plugin
module.exports = {"spectrum-selector":"spectrum-selector__2ngOB","spectrum-container":"spectrum-container__1b5mz","spectrum-circle":"spectrum-circle__ONOwc","spectrum-circle__color":"spectrum-circle__color__hv5xB","spectrum-selector__color":"spectrum-selector__color__1BgUm","spectrum-selector__decoration":"spectrum-selector__decoration__1xa9V","spectrum-selector__decoration--mark":"spectrum-selector__decoration--mark__zmotZ","spectrum-selector__decoration--secondary":"spectrum-selector__decoration--secondary__jVdXg","spectrum-selector__decoration--primary":"spectrum-selector__decoration--primary__2lvPG","spectrum-selector__luminosity":"spectrum-selector__luminosity__18Azl","spectrum-selector__saturation":"spectrum-selector__saturation__3swnH","spectrum-selector__luminosity-level":"spectrum-selector__luminosity-level__e8vsc","spectrum-selector__saturation-level":"spectrum-selector__saturation-level__IYWl0","dot":"dot__3Wa_Y","dot2":"dot2__2wgHl"};
